...
<article>
<a href="fe_applicants.php" target="_blank"><h2>Click here to know the details about FE applicants</h2></a>
...
$result = mysqli_query($con,"SELECT * FROM feadmission");

while($row = mysqli_fetch_array($result)) {
  echo $row['Name'] . " " . $row['Contact'] . " " .$row['Address'] . " " .$row['HSC'] . " " . $row['JEE'] . " " .$row['Composite'] . " " . $row['DOB'];
  echo "<br>";
}
